...
static const char *locations[] = {".",          "../src/",
                                  "src/",       "../src/.libs/",
                                  "src/.libs/", NULL}; /* locations. */

static int test_ordinal(HMODULE hmod, const char *func_name, int ordinal)
{
    char *lpmsg;
    void *name, *ord;
...
static void win32_ordinal_test(void)
{
...
int main(void)
{
#ifdef TEST_WIN32 &&WIN32_TARGET_DLL
    win32_ordinal_test();
#endif
