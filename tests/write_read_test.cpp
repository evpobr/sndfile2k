...
int main(int argc, char **argv)
{
    ...
    if (do_all || !strcmp(argv[1], "wav"))
    {
        ...
        pcm_test_char("char.rifx",
                      SF_ENDIAN_BIG | SF_FORMAT_WAV | SF_FORMAT_PCM_U8,
                      SF_FALSE);
        pcm_test_short("short.rifx",
                       SF_ENDIAN_BIG | SF_FORMAT_WAV | SF_FORMAT_PCM_16,
                       SF_FALSE);
        pcm_test_24bit("24bit.rifx",
                       SF_ENDIAN_BIG | SF_FORMAT_WAV | SF_FORMAT_PCM_24,
                       SF_FALSE);
        pcm_test_int("int.rifx",
                     SF_ENDIAN_BIG | SF_FORMAT_WAV | SF_FORMAT_PCM_32,
                     SF_FALSE);

        pcm_test_24bit("24bit.wavex", SF_FORMAT_WAVEX | SF_FORMAT_PCM_24,
                       SF_FALSE);
        ...
        pcm_test_double("double.wav", SF_FORMAT_WAV | SF_FORMAT_DOUBLE,
                        SF_FALSE);

        pcm_test_float("float.rifx",
                       SF_ENDIAN_BIG | SF_FORMAT_WAV | SF_FORMAT_FLOAT,
                       SF_FALSE);
        pcm_test_double("double.rifx",
                        SF_ENDIAN_BIG | SF_FORMAT_WAV | SF_FORMAT_DOUBLE,
                        SF_FALSE);

        pcm_test_float("float.wavex", SF_FORMAT_WAVEX | SF_FORMAT_FLOAT,
                       SF_FALSE);
        pcm_test_double("double.wavex", SF_FORMAT_WAVEX | SF_FORMAT_DOUBLE,
                        SF_FALSE);
        /* Lite remove end */
    ...
    {
        pcm_test_char("char_u8.aiff", SF_FORMAT_AIFF | SF_FORMAT_PCM_U8,
                      SF_FALSE);
        pcm_test_char("char_s8.aiff", SF_FORMAT_AIFF | SF_FORMAT_PCM_S8,
                      SF_FALSE);
        pcm_test_short("short.aiff", SF_FORMAT_AIFF | SF_FORMAT_PCM_16,
                       SF_FALSE);
        pcm_test_24bit("24bit.aiff", SF_FORMAT_AIFF | SF_FORMAT_PCM_24,
                       SF_FALSE);
        pcm_test_int("int.aiff", SF_FORMAT_AIFF | SF_FORMAT_PCM_32, SF_FALSE);

        pcm_test_short("short_sowt.aifc",
                       SF_ENDIAN_LITTLE | SF_FORMAT_AIFF | SF_FORMAT_PCM_16,
                       SF_FALSE);
        pcm_test_24bit("24bit_sowt.aifc",
                       SF_ENDIAN_LITTLE | SF_FORMAT_AIFF | SF_FORMAT_PCM_24,
                       SF_FALSE);
        pcm_test_int("int_sowt.aifc",
                     SF_ENDIAN_LITTLE | SF_FORMAT_AIFF | SF_FORMAT_PCM_32,
                     SF_FALSE);

        pcm_test_short("short_twos.aifc",
                       SF_ENDIAN_BIG | SF_FORMAT_AIFF | SF_FORMAT_PCM_16,
                       SF_FALSE);
        pcm_test_24bit("24bit_twos.aifc",
                       SF_ENDIAN_BIG | SF_FORMAT_AIFF | SF_FORMAT_PCM_24,
                       SF_FALSE);
        pcm_test_int("int_twos.aifc",
                     SF_ENDIAN_BIG | SF_FORMAT_AIFF | SF_FORMAT_PCM_32,
                     SF_FALSE);

        /* Lite remove start */
        pcm_test_short("dwvw16.aifc", SF_FORMAT_AIFF | SF_FORMAT_DWVW_16,
                       SF_TRUE);
        pcm_test_24bit("dwvw24.aifc", SF_FORMAT_AIFF | SF_FORMAT_DWVW_24,
                       SF_TRUE);

        pcm_test_float("float.aifc", SF_FORMAT_AIFF | SF_FORMAT_FLOAT,
                       SF_FALSE);
        pcm_test_double("double.aifc", SF_FORMAT_AIFF | SF_FORMAT_DOUBLE,
                        SF_FALSE);
        /* Lite remove end */
    ...
    if (do_all || !strcmp(argv[1], "au"))
    {
        ...
        pcm_test_char("char_le.au",
                      SF_ENDIAN_LITTLE | SF_FORMAT_AU | SF_FORMAT_PCM_S8,
                      SF_FALSE);
        pcm_test_short("short_le.au",
                       SF_ENDIAN_LITTLE | SF_FORMAT_AU | SF_FORMAT_PCM_16,
                       SF_FALSE);
        pcm_test_24bit("24bit_le.au",
                       SF_ENDIAN_LITTLE | SF_FORMAT_AU | SF_FORMAT_PCM_24,
                       SF_FALSE);
        pcm_test_int("int_le.au",
                     SF_ENDIAN_LITTLE | SF_FORMAT_AU | SF_FORMAT_PCM_32,
                     SF_FALSE);
        /* Lite remove start */
        pcm_test_float("float_le.au",
                       SF_ENDIAN_LITTLE | SF_FORMAT_AU | SF_FORMAT_FLOAT,
                       SF_FALSE);
        pcm_test_double("double_le.au",
    ...
    if (do_all || !strcmp(argv[1], "caf"))
    {
        ...
        pcm_test_double("double.caf", SF_FORMAT_CAF | SF_FORMAT_DOUBLE,
                        SF_FALSE);
        /* Lite remove end */

        pcm_test_short("short_le.caf",
                       SF_ENDIAN_LITTLE | SF_FORMAT_CAF | SF_FORMAT_PCM_16,
                       SF_FALSE);
        pcm_test_24bit("24bit_le.caf",
                       SF_ENDIAN_LITTLE | SF_FORMAT_CAF | SF_FORMAT_PCM_24,
                       SF_FALSE);
        pcm_test_int("int_le.caf",
                     SF_ENDIAN_LITTLE | SF_FORMAT_CAF | SF_FORMAT_PCM_32,
                     SF_FALSE);
        /* Lite remove start */
        pcm_test_float("float_le.caf",
                       SF_ENDIAN_LITTLE | SF_FORMAT_CAF | SF_FORMAT_FLOAT,
                       SF_FALSE);
        pcm_test_double("double_le.caf",
                        SF_ENDIAN_LITTLE | SF_FORMAT_CAF | SF_FORMAT_DOUBLE,
                        SF_FALSE);

        pcm_test_short("alac16.caf", SF_FORMAT_CAF | SF_FORMAT_ALAC_16,
                       SF_FALSE);
        pcm_test_20bit("alac20.caf", SF_FORMAT_CAF | SF_FORMAT_ALAC_20,
                       SF_FALSE);
        pcm_test_24bit("alac24.caf", SF_FORMAT_CAF | SF_FORMAT_ALAC_24,
                       SF_FALSE);
    ...
    {
        pcm_test_char("char_le.paf",
                      SF_ENDIAN_LITTLE | SF_FORMAT_PAF | SF_FORMAT_PCM_S8,
                      SF_FALSE);
        pcm_test_char("char_be.paf",
                      SF_ENDIAN_BIG | SF_FORMAT_PAF | SF_FORMAT_PCM_S8,
                      SF_FALSE);
        pcm_test_short("short_le.paf",
                       SF_ENDIAN_LITTLE | SF_FORMAT_PAF | SF_FORMAT_PCM_16,
                       SF_FALSE);
        pcm_test_short("short_be.paf",
                       SF_ENDIAN_BIG | SF_FORMAT_PAF | SF_FORMAT_PCM_16,
                       SF_FALSE);
        pcm_test_24bit("24bit_le.paf",
                       SF_ENDIAN_LITTLE | SF_FORMAT_PAF | SF_FORMAT_PCM_24,
                       SF_TRUE);
        pcm_test_24bit("24bit_be.paf",
                       SF_ENDIAN_BIG | SF_FORMAT_PAF | SF_FORMAT_PCM_24,
                       SF_TRUE);
        test_count++;
    };
    ...
    {
        pcm_test_short("short_le.nist",
                       SF_ENDIAN_LITTLE | SF_FORMAT_NIST | SF_FORMAT_PCM_16,
                       SF_FALSE);
        pcm_test_short("short_be.nist",
                       SF_ENDIAN_BIG | SF_FORMAT_NIST | SF_FORMAT_PCM_16,
                       SF_FALSE);
        pcm_test_24bit("24bit_le.nist",
                       SF_ENDIAN_LITTLE | SF_FORMAT_NIST | SF_FORMAT_PCM_24,
                       SF_FALSE);
        pcm_test_24bit("24bit_be.nist",
                       SF_ENDIAN_BIG | SF_FORMAT_NIST | SF_FORMAT_PCM_24,
                       SF_FALSE);
        pcm_test_int("int_le.nist",
                     SF_ENDIAN_LITTLE | SF_FORMAT_NIST | SF_FORMAT_PCM_32,
                     SF_FALSE);
        pcm_test_int("int_be.nist",
                     SF_ENDIAN_BIG | SF_FORMAT_NIST | SF_FORMAT_PCM_32,
                     SF_FALSE);
    ...
    {
        pcm_test_short("short_be.ircam",
                       SF_ENDIAN_BIG | SF_FORMAT_IRCAM | SF_FORMAT_PCM_16,
                       SF_FALSE);
        pcm_test_short("short_le.ircam",
                       SF_ENDIAN_LITTLE | SF_FORMAT_IRCAM | SF_FORMAT_PCM_16,
                       SF_FALSE);
        pcm_test_int("int_be.ircam",
                     SF_ENDIAN_BIG | SF_FORMAT_IRCAM | SF_FORMAT_PCM_32,
                     SF_FALSE);
        pcm_test_int("int_le.ircam",
                     SF_ENDIAN_LITTLE | SF_FORMAT_IRCAM | SF_FORMAT_PCM_32,
                     SF_FALSE);
        pcm_test_float("float_be.ircam",
                       SF_ENDIAN_BIG | SF_FORMAT_IRCAM | SF_FORMAT_FLOAT,
                       SF_FALSE);
        pcm_test_float("float_le.ircam",
                       SF_ENDIAN_LITTLE | SF_FORMAT_IRCAM | SF_FORMAT_FLOAT,
                       SF_FALSE);
    ...
    {
        pcm_test_short("short_be.mat4",
                       SF_ENDIAN_BIG | SF_FORMAT_MAT4 | SF_FORMAT_PCM_16,
                       SF_FALSE);
        pcm_test_short("short_le.mat4",
                       SF_ENDIAN_LITTLE | SF_FORMAT_MAT4 | SF_FORMAT_PCM_16,
                       SF_FALSE);
        pcm_test_int("int_be.mat4",
                     SF_ENDIAN_BIG | SF_FORMAT_MAT4 | SF_FORMAT_PCM_32,
                     SF_FALSE);
        pcm_test_int("int_le.mat4",
                     SF_ENDIAN_LITTLE | SF_FORMAT_MAT4 | SF_FORMAT_PCM_32,
                     SF_FALSE);
        pcm_test_float("float_be.mat4",
                       SF_ENDIAN_BIG | SF_FORMAT_MAT4 | SF_FORMAT_FLOAT,
                       SF_FALSE);
        pcm_test_float("float_le.mat4",
                       SF_ENDIAN_LITTLE | SF_FORMAT_MAT4 | SF_FORMAT_FLOAT,
                       SF_FALSE);
        pcm_test_double("double_be.mat4",
                        SF_ENDIAN_BIG | SF_FORMAT_MAT4 | SF_FORMAT_DOUBLE,
                        SF_FALSE);
        pcm_test_double("double_le.mat4",
                        SF_ENDIAN_LITTLE | SF_FORMAT_MAT4 | SF_FORMAT_DOUBLE,
                        SF_FALSE);
    ...
    {
        pcm_test_char("char_be.mat5",
                      SF_ENDIAN_BIG | SF_FORMAT_MAT5 | SF_FORMAT_PCM_U8,
                      SF_FALSE);
        pcm_test_char("char_le.mat5",
                      SF_ENDIAN_LITTLE | SF_FORMAT_MAT5 | SF_FORMAT_PCM_U8,
                      SF_FALSE);
        pcm_test_short("short_be.mat5",
                       SF_ENDIAN_BIG | SF_FORMAT_MAT5 | SF_FORMAT_PCM_16,
                       SF_FALSE);
        pcm_test_short("short_le.mat5",
                       SF_ENDIAN_LITTLE | SF_FORMAT_MAT5 | SF_FORMAT_PCM_16,
                       SF_FALSE);
        pcm_test_int("int_be.mat5",
                     SF_ENDIAN_BIG | SF_FORMAT_MAT5 | SF_FORMAT_PCM_32,
                     SF_FALSE);
        pcm_test_int("int_le.mat5",
                     SF_ENDIAN_LITTLE | SF_FORMAT_MAT5 | SF_FORMAT_PCM_32,
                     SF_FALSE);
        pcm_test_float("float_be.mat5",
                       SF_ENDIAN_BIG | SF_FORMAT_MAT5 | SF_FORMAT_FLOAT,
                       SF_FALSE);
        pcm_test_float("float_le.mat5",
                       SF_ENDIAN_LITTLE | SF_FORMAT_MAT5 | SF_FORMAT_FLOAT,
                       SF_FALSE);
        pcm_test_double("double_be.mat5",
                        SF_ENDIAN_BIG | SF_FORMAT_MAT5 | SF_FORMAT_DOUBLE,
                        SF_FALSE);
        pcm_test_double("double_le.mat5",
                        SF_ENDIAN_LITTLE | SF_FORMAT_MAT5 | SF_FORMAT_DOUBLE,
                        SF_FALSE);
    ...
    {
        pcm_test_short("short.mpc", SF_FORMAT_MPC2K | SF_FORMAT_PCM_16,
                       SF_FALSE);
        test_count++;
    };
    ...
    {
        pcm_test_char("char_u8.avr", SF_FORMAT_AVR | SF_FORMAT_PCM_U8,
                      SF_FALSE);
        pcm_test_char("char_s8.avr", SF_FORMAT_AVR | SF_FORMAT_PCM_S8,
                      SF_FALSE);
    ...
    if (do_all || !strcmp(argv[1], "w64"))
    {
        ...
        pcm_test_double("double.w64", SF_FORMAT_W64 | SF_FORMAT_DOUBLE,
                        SF_FALSE);
        /* Lite remove end */
    ...
    if (do_all || !strcmp(argv[1], "flac"))
    {
#ifdef HAVE_XIPH_CODECS
        {
            pcm_test_char("char.flac", SF_FORMAT_FLAC | SF_FORMAT_PCM_S8,
                          SF_TRUE);
            pcm_test_short("short.flac", SF_FORMAT_FLAC | SF_FORMAT_PCM_16,
                           SF_TRUE);
            pcm_test_24bit("24bit.flac", SF_FORMAT_FLAC | SF_FORMAT_PCM_24,
                           SF_TRUE);
        }
#else
    ...
    if (do_all || !strcmp(argv[1], "rf64"))
    {
        ...
        pcm_test_short("short.rf64", SF_FORMAT_RF64 | SF_FORMAT_PCM_16,
                       SF_FALSE);
        pcm_test_24bit("24bit.rf64", SF_FORMAT_RF64 | SF_FORMAT_PCM_24,
                       SF_FALSE);
        pcm_test_int("int.rf64", SF_FORMAT_RF64 | SF_FORMAT_PCM_32, SF_FALSE);

        /* Lite remove start */
        pcm_test_float("float.rf64", SF_FORMAT_RF64 | SF_FORMAT_FLOAT,
                       SF_FALSE);
        pcm_test_double("double.rf64", SF_FORMAT_RF64 | SF_FORMAT_DOUBLE,
                        SF_FALSE);
...
static void pcm_test_char(const char *filename, int format, int long_file_ok)
{
    SF_INFO sfinfo;
    short *orig;
    int k, allow_fd;
    ...
    sfinfo.frames =
        SILLY_WRITE_COUNT; /* Wrong length. Library should correct this on sf_close. */
    sfinfo.channels = 1;
                           ...
                           int allow_fd)
{
    ...
    {
        printf("\n\nLine %d : Mono : Returned format incorrect (0x%08X => "
               "0x%08X).\n",
    ...
    {
        printf("\n\nLine %d : Mono : Incorrect number of frames in file (too "
               "short). (%" PRId64 " should be %d)\n",
    ...
    for (k = 0; k < items; k++)
        ...
        {
            printf("\n\nLine %d: Mono : Incorrect sample A (#%d : 0x%X => "
                   "0x%X).\n",
    ...
    test_seek_or_die(file, items + 10, SEEK_SET, items + 10, sfinfo.channels,
                     __LINE__);
    ...
    for (k = 10; k < 14; k++)
        if (CHAR_ERROR(orig[k], test[k]))
        {
            printf("\n\nLine %d : Mono : Incorrect sample D (#%d : 0x%X => "
                   "0x%X).\n",
                   __LINE__, k, test[k], orig[k]);
            exit(1);
        };
    ...
    {
        printf("\n\nLines %d : read past end of file (%" PRId64
               " should be %" PRId64 ")\n",
               __LINE__, count, sfinfo.frames);
        exit(1);
    };

    test_seek_or_die(file, 0, SEEK_CUR, sfinfo.frames, sfinfo.channels,
                     __LINE__);
                             ...
                             int allow_fd)
{
    ...
    if (sfinfo.format != format)
    {
        printf("\n\nLine %d : Stereo : Returned format incorrect (0x%08X => "
               "0x%08X).\n",
               __LINE__, format, sfinfo.format);
        exit(1);
    };
    ...
    {
        printf("\n\nLine %d : Stereo : Incorrect number of frames in file (too "
               "short). (%" PRId64 " should be %d)\n",
    ...
    for (k = 0; k < items; k++)
        ...
        {
            printf("\n\nLine %d : Stereo : Incorrect sample (#%d : 0x%X => "
                   "0x%X).\n",
                   __LINE__, k, orig[k], test[k]);
            exit(1);
        };
                                ...
                                int long_file_ok, int allow_fd)
{
    ...
    else
    {
		...
		*/
        ...
        {
            printf("\n\nLine %d: truncate_file_to_zero (%s) failed", __LINE__,
                   filename);
            perror(NULL);
            exit(1);
        };
	...
	*/
    for (pass = 1; pass <= 3; pass++)
    {
        ...
        test_read_write_position_or_die(
            file, __LINE__, pass, (pass - 1) * DATA_LENGTH, pass * DATA_LENGTH);
        ...
        for (k = 0; k < DATA_LENGTH; k++)
            if (CHAR_ERROR(orig[k], test[k]))
            {
                printf("\n\nLine %d (pass %d) A : Error at sample %d (0x%X => "
                       "0x%X).\n",
        ...
        test_read_write_position_or_die(file, __LINE__, pass,
                                        pass * DATA_LENGTH, pass * DATA_LENGTH);
    }; /* for (pass ...) */
    ...
    if (!long_file_ok)
        ...
        test_seek_or_die(file, 3 * DATA_LENGTH, SFM_WRITE | SEEK_SET,
                         3 * DATA_LENGTH, sfinfo.channels, __LINE__);
    ...
    for (pass = 1; pass <= 3; pass++)
    {
        ...
        test_read_write_position_or_die(
            file, __LINE__, pass, (pass - 1) * DATA_LENGTH, 3 * DATA_LENGTH);
        ...
        for (k = 0; k < DATA_LENGTH; k++)
            if (CHAR_ERROR(orig[k], test[k]))
            {
                printf("\n\nLine %d (pass %d) B : Error at sample %d (0x%X => "
                       "0x%X).\n",
                       __LINE__, pass, k, orig[k], test[k]);
                oct_save_short(orig, test, DATA_LENGTH);
                exit(1);
...
static void pcm_test_short(const char *filename, int format, int long_file_ok)
{
    SF_INFO sfinfo;
    short *orig;
    int k, allow_fd;
...
static void pcm_test_20bit(const char *filename, int format, int long_file_ok)
{
    SF_INFO sfinfo;
    int *orig;
    int k, allow_fd;
...
static void pcm_test_24bit(const char *filename, int format, int long_file_ok)
{
    SF_INFO sfinfo;
    int *orig;
    int k, allow_fd;
...
static void pcm_test_int(const char *filename, int format, int long_file_ok)
{
    SF_INFO sfinfo;
    int *orig;
    int k, allow_fd;
...
static void pcm_test_float(const char *filename, int format, int long_file_ok)
{
    SF_INFO sfinfo;
    float *orig;
    int k, allow_fd;
                            ...
                            int allow_fd)
{
    ...
    for (k = 1; k <= 32; k++)
    {
        ...
        for (ik = 0; ik < total; ik++)
            ...
            {
                printf("\n\nLine %d : Mono : Incorrect sample A (#%d : %g => "
                       "%g).\n",
                       __LINE__, ik, orig[ik], test[ik]);
                exit(1);
            };
	...
	*/
    for (pass = 1; pass <= 3; pass++)
    {
        ...
        for (k = 0; k < DATA_LENGTH; k++)
            if (FLOAT_ERROR(orig[k], test[k]))
            {
                printf("\n\nLine %d (pass %d) A : Error at sample %d (%g => "
                       "%g).\n",
                       __LINE__, pass, k, orig[k], test[k]);
    ...
    for (pass = 1; pass <= 3; pass++)
    {
        ...
        for (k = 0; k < DATA_LENGTH; k++)
            if (FLOAT_ERROR(orig[k], test[k]))
            {
                printf("\n\nLine %d (pass %d) B : Error at sample %d (%g => "
                       "%g).\n",
                       __LINE__, pass, k, orig[k], test[k]);
                oct_save_float(orig, test, DATA_LENGTH);
                exit(1);
...
static void pcm_test_double(const char *filename, int format, int long_file_ok)
{
    SF_INFO sfinfo;
    double *orig;
    int k, allow_fd;
...
static void write_seek_extend_test(const char *filename, int format)
{
    ...
    test_seek_or_die(file, 2 * items, SEEK_SET, 2 * items, info.channels,
                     __LINE__);
    ...
    for (k = 0; k < items; k++)
    {
        exit_if_true(test[k] != 0x3fff,
                     "Line %d : test [%d] == %d, should be 0x3fff.\n", __LINE__,
                     k, test[k]);
        exit_if_true(test[items + k] != 0,
                     "Line %d : test [%d] == %d, should be 0.\n", __LINE__,
                     items + k, test[items + k]);
        exit_if_true(test[2 * items + k] != 0x3fff,
                     "Line %d : test [%d] == %d, should be 0x3fff.\n", __LINE__,
                     2 * items + k, test[2 * items + k]);
    };
