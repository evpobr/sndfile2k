...
static void alaw2f_array(unsigned char *buffer, size_t count, float *ptr, float normfact);
static void alaw2d_array(unsigned char *buffer, size_t count, double *ptr, double normfact);
...
static void f2alaw_array(const float *buffer, size_t count, unsigned char *ptr, float normfact);
static void d2alaw_array(const double *buffer, size_t count, unsigned char *ptr, double normfact);
...
static inline void alaw2f_array(unsigned char *buffer, size_t count, float *ptr, float normfact)
{
    while (count)
    {
        count--;
...
static inline void alaw2d_array(unsigned char *buffer, size_t count, double *ptr, double normfact)
{
    while (count)
    {
        count--;
...
static inline void s2alaw_array(const short *ptr, size_t count, unsigned char *buffer)
{
    while (count)
    {
        count--;
...
static inline void i2alaw_array(const int *ptr, size_t count, unsigned char *buffer)
{
    while (count)
    {
        count--;
...
static inline void f2alaw_array(const float *ptr, size_t count, unsigned char *buffer,
                                float normfact)
{
    while (count)
    {
...
static inline void d2alaw_array(const double *ptr, size_t count, unsigned char *buffer,
                                double normfact)
{
    while (count)
    {
...
static size_t alaw_write_f2alaw(SF_PRIVATE *psf, const float *ptr, size_t len)
{
    ...
    normfact = (float)((psf->m_norm_float == SF_TRUE) ? (1.0 * 0x7FFF) / 16.0 : 1.0 / 16);
...
static size_t alaw_write_d2alaw(SF_PRIVATE *psf, const double *ptr, size_t len)
{
    ...
    normfact = (psf->m_norm_double) ? (1.0 * 0x7FFF) / 16.0 : 1.0 / 16.0;
