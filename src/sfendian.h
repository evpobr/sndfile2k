...
static inline int16_t ENDSWAP_16(int16_t x)
{
    int16_t y;
...
static inline int32_t ENDSWAP_32(int32_t x)
{
    int32_t y;
...
static inline int64_t ENDSWAP_64X(int64_t x)
{
    int64_t y;
...
#ifndef ENDSWAP_64
static inline uint64_t ENDSWAP_64(uint64_t x)
{
    union
    {
        uint32_t parts[2];
...
static inline void psf_put_be64(uint8_t *ptr, int offset, int64_t value)
{
...
static inline void psf_put_be32(uint8_t *ptr, int offset, int32_t value)
{
    ptr[offset] = value >> 24;
...
static inline void psf_put_be16(uint8_t *ptr, int offset, int16_t value)
{
    ptr[offset] = (uint8_t)(value >> 8);
    ptr[offset + 1] = (uint8_t)(value);
} /* psf_put_be16 */

static inline int64_t psf_get_be64(uint8_t *ptr, int offset)
{
    int64_t value;
...
static inline int64_t psf_get_le64(uint8_t *ptr, int offset)
{
    int64_t value;
...
static inline int32_t psf_get_be32(uint8_t *ptr, int offset)
{
    int32_t value;
...
static inline int32_t psf_get_le32(uint8_t *ptr, int offset)
{
    int32_t value;
...
static inline int32_t psf_get_be24(uint8_t *ptr, int offset)
{
    int32_t value;
...
static inline int16_t psf_get_be16(uint8_t *ptr, int offset)
{
...
static inline void endswap_double_copy(double *dest, const double *src, int len)
{
