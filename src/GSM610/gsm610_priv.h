...
static inline int16_t SASR_W(int16_t x, int16_t by)
{
    if (x >= 0)
        return x >> by;
    return ~((~x) >> by);
...
static inline int32_t SASR_L(int32_t x, int16_t by)
{
    if (x >= 0)
        return x >> by;
    return ~((~x) >> by);
...
static inline int16_t SASL_W(int16_t x, int16_t by)
{
    if (x >= 0)
        return x << by;
    return -((-x) << by);
...
static inline int32_t SASL_L(int32_t x, int16_t by)
{
    if (x >= 0)
        return x << by;
    return -((-x) << by);
...
static inline int32_t GSM_MULT_R(int16_t a, int16_t b)
{
    return (((int32_t)(a)) * ((int32_t)(b)) + 16384) >> 15;
}

static inline int32_t GSM_MULT(int16_t a, int16_t b)
{
...
static inline int32_t GSM_ADD(int16_t a, int16_t b)
{
    int32_t ltmp;
...
static inline int32_t GSM_SUB(int16_t a, int16_t b)
{
    int32_t ltmp;
...
void Gsm_Decoding(struct gsm_state *S, int16_t xmaxcr, int16_t Mcr,
