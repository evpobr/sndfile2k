...
static SF_FORMAT_INFO const simple_formats[] = {
    ...
    {SF_FORMAT_AIFF | SF_FORMAT_FLOAT, "AIFF (Apple/SGI 32 bit float)", "aifc"},

    {SF_FORMAT_AIFF | SF_FORMAT_PCM_S8, "AIFF (Apple/SGI 8 bit PCM)", "aiff"},

    {SF_FORMAT_AU | SF_FORMAT_PCM_16, "AU (Sun/Next 16 bit PCM)", "au"},

    {SF_FORMAT_AU | SF_FORMAT_ULAW, "AU (Sun/Next 8-bit u-law)", "au"},

    {SF_FORMAT_CAF | SF_FORMAT_ALAC_16, "CAF (Apple 16 bit ALAC)", "caf"},
    ...
    {SF_FORMAT_WAV | SF_FORMAT_PCM_16, "WAV (Microsoft 16 bit PCM)", "wav"},
...
double psf_calc_signal_max(SF_PRIVATE *psf, int normalize)
{
    ...
    for (readcount = 1, max_val = 0.0; readcount > 0;)
    {
