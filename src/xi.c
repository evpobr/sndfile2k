...
static sf_count_t dpcm_read_dles2d(SF_PRIVATE *psf, double *ptr,
                                   sf_count_t len);
...
static void dsc2s_array(XI_PRIVATE *pxi, signed char *src, int count,
                        short *dest);
static void dsc2i_array(XI_PRIVATE *pxi, signed char *src, int count,
                        int *dest);
