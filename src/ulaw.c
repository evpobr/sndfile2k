...
static inline void ulaw2f_array(unsigned char *buffer, size_t count, float *ptr,
                                float normfact)
{
    while (count)
    {
...
static inline void ulaw2d_array(const unsigned char *buffer, size_t count,
...
static inline void s2ulaw_array(const short *ptr, size_t count,
...
static inline void i2ulaw_array(const int *ptr, size_t count,
                                unsigned char *buffer)
{
	while (count)
	{
...
static inline void f2ulaw_array(const float *ptr, size_t count,
...
static inline void d2ulaw_array(const double *ptr, size_t count,
