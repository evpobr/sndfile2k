...
static const int two_channel_stereo[2] = {SF_CHANNEL_MAP_LEFT,
...
static const AIFF_CAF_CHANNEL_MAP three_chan[] = {
    ...
    {(133 << 16) | 3, three_channel_dvd_4,
     "DVD 4 (L, R, LFE)"}};

static const int four_channel_ambisonc_b[4] = {
    SF_CHANNEL_MAP_AMBISONIC_B_W, SF_CHANNEL_MAP_AMBISONIC_B_X,
...
static const AIFF_CAF_CHANNEL_MAP four_chan[] = {
    ...
    {(136 << 16) | 4, four_channel_dvd_10,
     "DVD 10 (L, R, C, LFE)"}}; /* four_chan */

static const int five_channel_pentagonal[5] = {
    SF_CHANNEL_MAP_LEFT, SF_CHANNEL_MAP_RIGHT, SF_CHANNEL_MAP_REAR_LEFT,
    SF_CHANNEL_MAP_REAR_RIGHT, SF_CHANNEL_MAP_CENTER};
...
static const AIFF_CAF_CHANNEL_MAP five_chan[] = {
    {(109 << 16) | 5, five_channel_pentagonal,
     "pentagonal (L,  R, Lrear, Rrear, C)"},
    ...
    {(138 << 16) | 5, five_channel_dvd_18,
     "DVD 18 (L, R, Ls, Rs, LFE)"}};
...
static const int six_channel_mpeg_51_b[6] = {
    SF_CHANNEL_MAP_LEFT,       SF_CHANNEL_MAP_RIGHT,  SF_CHANNEL_MAP_REAR_LEFT,
    SF_CHANNEL_MAP_REAR_RIGHT, SF_CHANNEL_MAP_CENTER, SF_CHANNEL_MAP_LFE};
...
static const int six_channel_aac_60[6] = {
    SF_CHANNEL_MAP_CENTER,     SF_CHANNEL_MAP_LEFT,
...
static const AIFF_CAF_CHANNEL_MAP six_chan[] = {
    ...
    {(121 << 16) | 6, six_channel_mpeg_51_a,
     "MPEG 5.1 A (L, R, C, LFE, Ls, Rs)"},
    {(122 << 16) | 6, six_channel_mpeg_51_b,
     "MPEG 5.1 B (L, R, Ls, Rs, C, LFE)"},
    {(123 << 16) | 6, six_channel_mpeg_51_c,
     "MPEG 5.1 C (L, C, R, Ls, Rs, LFE)"},
    {(124 << 16) | 6, six_channel_mpeg_51_d,
     "MPEG 5.1 D (C, L, R, Ls, Rs, LFE)"},
    {(139 << 16) | 6, six_channel_audio_unit_60,
     "AudioUnit 6.0 (L, R, Ls, Rs, C, Cs)"},
    {(141 << 16) | 6, six_channel_aac_60,
     "AAC 6.0 (C, L, R, Ls, Rs, Cs)"}};
...
static const AIFF_CAF_CHANNEL_MAP eight_chan[] = {
    ...
    {(129 << 16) | 8, NULL,
     "Emagic Default 7.1 (L, R, Ls, Rs, C, LFE, Lc, Rc)"},
    {(130 << 16) | 8, NULL,
     // (ITU_5_1 plus a matrix encoded stereo mix)
     "SMPTE DTV (L, R, C, LFE, Ls, Rs, Lt, Rt)"},
    {(144 << 16) | 8, NULL,
     "AAC octagonal (C, L, R, Ls, Rs, Rls, Rrs, Cs)"}};
